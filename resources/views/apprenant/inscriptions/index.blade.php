...
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-800">📋 Mes Inscriptions</h1>
</div>
    ...
    <table class="w-full text-sm">
        ...
        <tbody>
            ...
            <tr class="border-t hover:bg-gray-50">
                <td class="px-5 py-4">
                    <p class="font-semibold">{{ $inscription->formation->titre }}</p>
                    <p class="text-xs text-gray-400">
                        {{ $inscription->formation->sousCategorie->nom ?? 'N/A' }}
                    </p>
                </td>
                <td class="px-5 py-4">
                ...
                <td class="px-5 py-4">
                    <div class="flex gap-2">
                        ...
                        @if($inscription->statut === 'en_attente')
                            <form method="POST"
                                  action="{{ route('apprenant.inscriptions.annuler', $inscription->id) }}"
